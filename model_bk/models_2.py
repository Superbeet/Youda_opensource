...
class Associations(models.Model):
    ...
    user = models.ForeignKey('UsersAffiliates')
...
class InvitationUsers(models.Model):
    ...
    question = models.ForeignKey('Questions')
    send_user = models.ForeignKey('Users', related_name='all_send_users')
...
class PrivateLetters(models.Model):
    ...
    send_user = models.ForeignKey('Users', related_name='all_sendletter_users', blank=True, null=True)#related_name='aa'
#     send_user_name = models.CharField(max_length=10, blank=True)
...
class TopicFocus(models.Model):
    focus_id = models.IntegerField(primary_key=True)
    focus_topic = models.ForeignKey('Topics')
    user_id = models.IntegerField(blank=True, null=True)
...
#     def __unicode__(self):
#         return "[focus_id:"+str(self.focus_id)+",topic_id:"+str(self.topic_id)+",user_id:"+str(self.user_id)+"]"
#     objects = models.Manager()
#     common_objects = CommonDao();  

# class TopicSchool(models.Model):
#     primary_id = models.IntegerField(primary_key=True)
#     topic_id = models.IntegerField(blank=True, null=True)
#     shool_id = models.IntegerField(blank=True, null=True)
#     created_time = models.DateTimeField(blank=True, null=True,default=datetime.now)

#     class Meta:
#         managed = False
#         db_table = 'topic_school'
#     def __unicode__(self):
#         return "[primary_id:"+str(self.primary_id)+",topic_id:"+str(self.topic_id)+",shool_id:"+str(self.shool_id)+"]"
#     objects = models.Manager()
#     common_objects = CommonDao();  
...
class UsersAffiliates(models.Model):
